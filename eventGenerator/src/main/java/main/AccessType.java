...
public class AccessType {
	 public static String generateMachine(int nmc) {
	    ...
	    public static String[] createInitialFile(String executionlogdir) {
	    	...
	    	String createLog = "echo '{\"event\":\"created\",\"sourceFile\":\""+initialFile+"\",\"targetFile\":\""+initialFile+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"host\":\"'$(hostname)'\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
	    	command[1] = "touch "+initialFile+" && "+createLog;
	    	    	 return command;
	    }
	    
	    public static String removeFile(String fileName, String executionlogdir) {
	    	String delLog = "echo '{\"event\":\"deleted\",\"sourceFile\":\""+fileName+"\",\"targetFile\":\""+fileName+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"host\":\"'$(hostname)'\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
	    ...
	    public static String[] renameFile(String fileName, String executionlogdir) {
	    	...
	    	String renLog = "echo '{\"event\":\"renamed\",\"sourceFile\":\""+fileName+"\",\"targetFile\":\""+renamed_file+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"host\":\"'$(hostname)'\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
	    ...
	    public static String[] copyFile(String fileName, String executionlogdir) {
	    	...
	    	String copyLog = "echo '{\"event\":\"copied\",\"sourceFile\":\""+fileName+"\",\"targetFile\":\""+copied_file+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"host\":\"'$(hostname)'\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
	    ...
	    public static String[] modifyFile(String fileName, String executionlogdir) {
	    	...
	    	String modifLog = "echo '{\"event\":\"modified\",\"sourceFile\":\""+fileName+"\",\"targetFile\":\""+fileName+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"host\":\"'$(hostname)'\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
		    
	    	String command = "echo 'this file has been modified on "+lt+" ' >> "+fileName+" && "+modifLog;
		...
		public static String[] secureCopyFileOtherMachine(String fileName, String agent, String agentdirectory, String executionlogdir) {
			//String secCopyLog = "echo '{\"event\":\"securedCopied\",\"sourceFile\":\""+fileName+"\",\"targetFile\":\""+fileName+"\",\"date\":\"'$(date --iso-8601=seconds)'\",\"sourceHost\":\"'$(hostname)'\",\"targetHost\":\""+agent+"\",\"user\":\"'$(whoami)'\"}' >> "+executionlogdir+"log-$(hostname).txt";
		   String secCopyLog="";
