...
public class LinuxExperimentSimple {
...
//=============file integrity===================================================================	
		...
		CsparqlQueryResultProxy createdProxy = engine.registerQuery(QueryLinuxSimple.created, false);
	    CsparqlQueryResultProxy deletedProxy = engine.registerQuery(QueryLinuxSimple.del, false);
		CsparqlQueryResultProxy modifiedProxy = engine.registerQuery(QueryLinuxSimple.modif, false);
		CsparqlQueryResultProxy renamedProxy = engine.registerQuery(QueryLinuxSimple.ren, false);
	CsparqlQueryResultProxy copiedProxy = engine.registerQuery(QueryLinuxSimple.copy, false);
