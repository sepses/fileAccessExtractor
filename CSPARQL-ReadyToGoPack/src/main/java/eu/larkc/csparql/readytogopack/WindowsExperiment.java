...
public class WindowsExperiment {
...
//=============file integrity===================================================================	
	//	CsparqlQueryResultProxy selectProxy = engine.registerQuery(Query.selectAll, false);
		CsparqlQueryResultProxy createdProxy = engine.registerQuery(QueryWin.created, false);
	    CsparqlQueryResultProxy deletedProxy = engine.registerQuery(QueryWin.del, false);
		CsparqlQueryResultProxy modifiedProxy = engine.registerQuery(QueryWin.modif, false);
		CsparqlQueryResultProxy renamedProxy = engine.registerQuery(QueryWin.ren, false);
		CsparqlQueryResultProxy copiedProxy = engine.registerQuery(QueryWin.copy, false);
