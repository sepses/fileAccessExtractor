...
public class WindowsExperimentSimple {
...
//=============file integrity===================================================================	
	//	CsparqlQueryResultProxy selectProxy = engine.registerQuery(Query.selectAll, false);
		CsparqlQueryResultProxy createdProxy = engine.registerQuery(QueryWinSimple.created, false);
	    CsparqlQueryResultProxy deletedProxy = engine.registerQuery(QueryWinSimple.del, false);
		CsparqlQueryResultProxy modifiedProxy = engine.registerQuery(QueryWinSimple.modif, false);
		CsparqlQueryResultProxy renamedProxy = engine.registerQuery(QueryWinSimple.ren, false);
		CsparqlQueryResultProxy copiedProxy = engine.registerQuery(QueryWinSimple.copy, false);
