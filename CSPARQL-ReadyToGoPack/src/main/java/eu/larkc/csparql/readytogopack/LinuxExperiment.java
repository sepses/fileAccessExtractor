...
//=============file integrity===================================================================	
	//	CsparqlQueryResultProxy selectProxy = engine.registerQuery(Query.selectAll, false);
		CsparqlQueryResultProxy createdProxy = engine.registerQuery(Query.created, false);
	    CsparqlQueryResultProxy deletedProxy = engine.registerQuery(Query.del, false);
		CsparqlQueryResultProxy modifiedProxy = engine.registerQuery(Query.modif, false);
		CsparqlQueryResultProxy renamedProxy = engine.registerQuery(Query.ren, false);
		CsparqlQueryResultProxy copiedProxy = engine.registerQuery(Query.copy, false);
